  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="adminlte/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light"><p class="font-italic">Gestión De Salas</p></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-header"><p class="font-italic">APARTADOS</p></li>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="solicitudsala" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p class="font-italic">Solicitud Sala</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="solicitudrecurso" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p class="font-italic">Solicitud Recurso</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a href="solicitudes" class="nav-link">
              ...
              <p class="font-italic">Historial Solicitudes</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="panelsolicitudes" class="nav-link">
              <i class="fa fa-desktop"></i>
              <p class="font-italic">Panel de solicitudes</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="configuracion" class="nav-link">
              <i class="fa fa-cog"></i>
              <p class="font-italic">Configuración</p>
            </a>
          </li>
        </ul>
      </nav>
